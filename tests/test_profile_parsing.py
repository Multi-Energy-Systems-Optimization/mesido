...
class TestProfileLoading(unittest.TestCase):
    ...
    #     # Check that the heat demand had an error
    #     np.testing.assert_equal(
    #         logs_list[2].msg == "Asset insufficient installed capacity: please increase the"
    #         " installed power or reduce the demand profile peak value of the demand(s) listed.",
    #         True,
    #     )
    #     np.testing.assert_equal(
    #         logs_list[0].msg == "HeatingDemand_506c: The installed capacity of 2.0MW should be"
    #         " larger than the maximum of the heat demand profile 1957.931MW",
    #         True,
    #     )
    #     np.testing.assert_equal(
    #         logs_list[1].msg == "HeatingDemand_6662: The installed capacity of 2.0MW should be"
    #         " larger than the maximum of the heat demand profile 1957.931MW",
    #         True,
    #     )
    #     # d
    #     np.testing.assert_equal(
    #         logs_list[3].msg == "Asset HeatingDemand_2ab9: This asset is currently a"
    #         " GenericConsumer please change it to a HeatingDemand",
    #         True,
    #     )
    #     np.testing.assert_equal(
    #         logs_list[4].msg == "Incorrect asset type: please update.",
    #         True,
    #     )
