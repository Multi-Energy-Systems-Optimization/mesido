...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="Untitled EnergySystem with return network" id="7ac09231-ce60-4c24-8338-9c0317695ba5_with_return_network" description="" esdlVersion="v2210" version="15">
  ...
  <instance xsi:type="esdl:Instance" id="f852b941-99fe-487b-a20d-01beff9e7c43" name="Untitled Instance">
    <area xsi:type="esdl:Area" id="f4acc7ef-a37d-43b7-87cb-8af5b82e3fed" name="Untitled Area">
      ...
      <asset xsi:type="esdl:Pipe" state="OPTIONAL" diameter="DN150" name="Pipe3" length="241.6" id="Pipe3" related="Pipe3_ret">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:HeatProducer" power="3500000.0" name="HeatProducer_1" id="324b0371-b738-4f55-a978-3306ee81638c" state="OPTIONAL" technicalLifetime="50.0">
      ...
      <asset xsi:type="esdl:Pipe" state="OPTIONAL" diameter="DN150" name="Pipe3_ret" length="241.6" id="Pipe3_ret" related="Pipe3">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:HeatProducer" power="5000000.0" name="HeatProducer_2" id="da00ddfc-cfa4-4f21-b5be-7c69d2bf53bb" state="OPTIONAL" technicalLifetime="20.0">
