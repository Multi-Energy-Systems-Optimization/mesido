...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="Untitled EnergySystem with return network" id="7ac09231-ce60-4c24-8338-9c0317695ba4_with_return_network" description="" esdlVersion="v2210" version="15">
  ...
  <instance xsi:type="esdl:Instance" id="f852b941-99fe-487b-a20d-01beff9e7c43" name="Untitled Instance">
    <area xsi:type="esdl:Area" id="f4acc7ef-a37d-43b7-87cb-8af5b82e3fed" name="Untitled Area">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe1" length="245.7" innerDiameter="0.4444" id="Pipe1" outerDiameter="0.63" related="Pipe1_ret">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe2" length="195.4" innerDiameter="0.4444" id="Pipe2" outerDiameter="0.63" related="Pipe2_ret">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe3" length="241.6" innerDiameter="0.4444" id="Pipe3" outerDiameter="0.63" related="Pipe3_ret">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe4" length="189.7" innerDiameter="0.4444" id="Pipe4" outerDiameter="0.63" related="Pipe4_ret">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe5" length="244.6" innerDiameter="0.4444" id="Pipe5" outerDiameter="0.63" related="Pipe5_ret">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe6" length="176.6" innerDiameter="0.4444" id="Pipe6" outerDiameter="0.63" related="Pipe6_ret">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe1_ret" length="245.7" innerDiameter="0.4444" id="Pipe1_ret" outerDiameter="0.63" related="Pipe1">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe2_ret" length="195.4" innerDiameter="0.4444" id="Pipe2_ret" outerDiameter="0.63" related="Pipe2">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe3_ret" length="241.6" innerDiameter="0.4444" id="Pipe3_ret" outerDiameter="0.63" related="Pipe3">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe4_ret" length="189.7" innerDiameter="0.4444" id="Pipe4_ret" outerDiameter="0.63" related="Pipe4">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe5_ret" length="244.6" innerDiameter="0.4444" id="Pipe5_ret" outerDiameter="0.63" related="Pipe5">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe6_ret" length="176.6" innerDiameter="0.4444" id="Pipe6_ret" outerDiameter="0.63" related="Pipe6">
        <geometry xsi:type="esdl:Line">
