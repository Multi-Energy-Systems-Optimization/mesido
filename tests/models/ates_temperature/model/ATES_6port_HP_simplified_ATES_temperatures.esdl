...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" version="93" id="6d632920-deae-4dc7-9870-0df7a8138870" description="" esdlVersion="v2401" name="ATES6port_HP_electricity">
  <instance xsi:type="esdl:Instance" id="5038aed8-004e-4841-976b-133b75f6264e" name="Untitled instance">
    <area xsi:type="esdl:Area" id="47f70d5c-e1ff-4c95-b27e-3c0801e251c1" name="Untitled area">
      <asset xsi:type="esdl:HeatPump" name="HeatPump_5e09" id="5e090abb-eeb2-4e62-b1db-611bd5874eb0" power="4000000.0" COP="4.0" efficiency="0.5">
      ...
      <asset xsi:type="esdl:HeatExchange" name="Hex_D1" id="a585fbb4-a62d-422a-ac14-deb267cc8a33" capacity="20000000.0">
        ...
        <port xsi:type="esdl:InPort" name="PrimIn" id="2e0ac4cd-9b10-46e3-8428-3b42f0ca2a50" connectedTo="5f5d8471-ea30-4789-8fd9-f8f2f67ff87d" carrier="3e394b4f-7857-4d5b-b60f-f6613502c425"/>
        ...
        <port xsi:type="esdl:OutPort" name="PrimOut" id="ea4ae0b1-1283-48bf-8b4d-f5795fc810b2" connectedTo="65a34255-c644-4f8b-93eb-bf9256c3d4d0" carrier="c941d80d-445a-4962-8e8d-cd310ae78d40"/>
      ...
      <asset xsi:type="esdl:Joint" id="5dded072-a944-4d6b-aeb4-417317777474" name="Joint_5dde">
        ...
        <port xsi:type="esdl:OutPort" id="601e1208-a2be-41f8-ae0c-8f369ed8bfd4" name="Out" connectedTo="6157fb6b-bc9e-44cb-914c-4c8dcf679f65 77a0213c-38c0-4765-9a8d-e64e7bd5521d" carrier="3e394b4f-7857-4d5b-b60f-f6613502c425"/>
      ...
      <asset xsi:type="esdl:Joint" id="ee380e31-7e89-487d-8af5-ccd0d79561ce" name="Joint_ee38">
        ...
        <port xsi:type="esdl:OutPort" id="72c1d574-3c4a-46ae-bc4f-1e0895b058ba" name="Out" connectedTo="a0988145-51dc-4b0d-8ec1-74fb4b8239df" carrier="31e15344-5c5a-42ce-a7b4-8eee2ebd36f9"/>
      ...
      <asset xsi:type="esdl:Joint" id="c4c17c09-94fc-43e1-998f-aa893964a976" name="Joint_c4c1">
        ...
        <port xsi:type="esdl:OutPort" id="5e82abe7-be73-4872-aaaf-ba975c77be8c" name="Out" carrier="cdb0f4d4-cbc6-4a2a-88fa-885a6412959f"/>
      ...
      <asset xsi:type="esdl:Joint" id="565842a9-7c59-4f06-a0da-465e3d91df8b" name="Joint_5658">
        <port xsi:type="esdl:InPort" id="55d062a3-6c86-47ec-a919-c00b377af2e8" name="In" carrier="21a8504f-454f-4779-8571-9dae4d5c6f0f"/>
      ...
      <asset xsi:type="esdl:Pipe" id="7a69b9ee-3457-44dc-8bfb-36335fdfcd47" name="Pipe_7a69" length="171.46" diameter="DN400">
        ...
        <port xsi:type="esdl:InPort" id="77a0213c-38c0-4765-9a8d-e64e7bd5521d" name="In" connectedTo="601e1208-a2be-41f8-ae0c-8f369ed8bfd4" carrier="3e394b4f-7857-4d5b-b60f-f6613502c425"/>
      ...
      <asset xsi:type="esdl:Pipe" name="Pipe_c137" length="76.31" id="c1376d13-b2d9-4460-96d2-07419133c682" diameter="DN400">
        ...
        <port xsi:type="esdl:InPort" id="65a34255-c644-4f8b-93eb-bf9256c3d4d0" name="In" connectedTo="ea4ae0b1-1283-48bf-8b4d-f5795fc810b2" carrier="c941d80d-445a-4962-8e8d-cd310ae78d40"/>
      ...
      <asset xsi:type="esdl:Pipe" name="Pipe_4763" length="353.52" id="47630c8e-3b97-4e63-8ffc-9323d2d1c07e" diameter="DN400">
        ...
        <port xsi:type="esdl:OutPort" id="5f5d8471-ea30-4789-8fd9-f8f2f67ff87d" name="Out" connectedTo="2e0ac4cd-9b10-46e3-8428-3b42f0ca2a50" carrier="3e394b4f-7857-4d5b-b60f-f6613502c425"/>
      </asset>
      ...
      <asset xsi:type="esdl:Pipe" name="Pipe_c327" length="62.6" id="c327283f-52b3-48fe-a77c-f6c6838f791e" diameter="DN400">
        ...
        <port xsi:type="esdl:InPort" id="a0988145-51dc-4b0d-8ec1-74fb4b8239df" name="In" connectedTo="72c1d574-3c4a-46ae-bc4f-1e0895b058ba" carrier="31e15344-5c5a-42ce-a7b4-8eee2ebd36f9"/>
      ...
      <asset xsi:type="esdl:ATES" id="1d313856-b807-454c-906a-e4fee49d9725" name="ATES_1d31" maxChargeRate="3610000.0" maxDischargeRate="3610000.0" aquiferTopDepth="300.0" aquiferThickness="45.0" aquiferMidTemperature="17.0" aquiferNetToGross="1.0" aquiferPorosity="0.3" aquiferPermeability="10000.0" aquiferAnisotropy="4.0" salinity="10000.0" wellCasingSize="13.0" wellDistance="150.0">
        ...
        <constraint xsi:type="esdl:RangedConstraint" id="219cc1ac-fb71-4635-b8a9-cee4415cba0d" name="ATESDischargeTemperatureRange">
          <range xsi:type="esdl:Range" id="108aba48-14e5-4ff9-8431-42155c7d5774" name="DischargeTemperature" maxValue="90.0" minValue="40.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" id="583b0d47-6b6c-49a2-a05e-c5a2df868abd" unit="DEGREES_CELSIUS" physicalQuantity="TEMPERATURE"/>
          </range>
        </constraint>
      </asset>
  ...
  <energySystemInformation xsi:type="esdl:EnergySystemInformation" id="e6148785-26f8-472c-864a-25d441f7be4a">
    <carriers xsi:type="esdl:Carriers" id="900cbe4e-1c63-4e1c-8ec1-c647e2392d88">
      <carrier xsi:type="esdl:HeatCommodity" id="0fe6b8fb-be02-484b-a909-0460f430cd06" name="Ates_hot" supplyTemperature="85.0"/>
