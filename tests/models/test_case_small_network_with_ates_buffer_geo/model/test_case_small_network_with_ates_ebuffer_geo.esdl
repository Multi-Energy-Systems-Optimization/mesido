...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="test_case_small_network_with_ates_ebuffer_geo" id="7ac09231-ce60-4c24-8338-9c0317695ba4_with_return_network" description="" esdlVersion="v2210" version="16">
  <energySystemInformation xsi:type="esdl:EnergySystemInformation" id="e64737d9-d772-4723-b092-a0b397ac00b3">
    <carriers xsi:type="esdl:Carriers" id="9dff13b9-77cd-4b99-8777-6b7680a155b6">
      ...
      <carrier xsi:type="esdl:ElectricityCommodity" id="61fe47b3-2024-4c8f-97a1-140242ef2d99" name="Electricity" voltage="230.0"/>
    </carriers>
  ...
  <instance xsi:type="esdl:Instance" id="f852b941-99fe-487b-a20d-01beff9e7c43" name="Untitled Instance">
    <area xsi:type="esdl:Area" id="f4acc7ef-a37d-43b7-87cb-8af5b82e3fed" name="Untitled Area">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe1" length="245.7" id="Pipe1" innerDiameter="0.4444" outerDiameter="0.63" related="Pipe1_ret">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe3" length="241.6" id="Pipe3" innerDiameter="0.4444" outerDiameter="0.63" related="Pipe3_ret">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe4" length="189.7" id="Pipe4" innerDiameter="0.4444" outerDiameter="0.63" related="Pipe4_ret">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe5" length="244.6" id="Pipe5" innerDiameter="0.4444" outerDiameter="0.63" related="Pipe5_ret">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe6" length="176.6" id="Pipe6" innerDiameter="0.4444" outerDiameter="0.63" related="Pipe6_ret">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Joint" name="Joint_1" id="f96d02d7-19d1-4a0b-8869-2d180f39b7e6">
        ...
        <port xsi:type="esdl:InPort" id="51852861-aeeb-461f-b8ec-08f000abc6dd" name="In" connectedTo="66590f96-a397-4d6f-9cfb-e7d34232cad6 f966bade-1fad-453f-8ec2-4062ec70bc7b 2e5a4c65-5fdf-4c39-b87a-2c9682b69e35" carrier="7b32e287-d775-480c-b317-64ffdacf12c9"/>
        <port xsi:type="esdl:OutPort" id="c0eac4db-f5da-47f3-8202-8438d000bd32" name="Out" connectedTo="5f65520d-61ee-4f68-8002-271f48f1daee 578ec414-3f11-430e-a893-60ea77848ff5 2e672d8b-ee9b-4c8b-8357-58ea984ae6be d89aec21-40a8-4014-86ee-2aba9f3ccbe5" carrier="7b32e287-d775-480c-b317-64ffdacf12c9"/>
      </asset>
      ...
      <asset xsi:type="esdl:ATES" aquiferNetToGross="1.0" name="ATES_033c" aquiferThickness="45.0" maxDischargeRate="11610000.0" wellCasingSize="13.0" aquiferAnisotropy="4.0" aquiferPorosity="0.3" aquiferMidTemperature="17.0" aquiferTopDepth="300.0" id="033c2598-5c1a-48b7-93b1-c746b81819ff" wellDistance="150.0" maxChargeRate="11610000.0" salinity="10000.0" aquiferPermeability="10000.0">
        ...
        <port xsi:type="esdl:InPort" id="33a9041b-dd75-42c0-94a3-584c5e374927" name="In" connectedTo="350d66d9-dea3-4a42-85e4-ec9e2c127444" carrier="7b32e287-d775-480c-b317-64ffdacf12c9"/>
        <port xsi:type="esdl:OutPort" id="0117d26b-8ab1-44b5-afee-51702e431e52" name="Out" connectedTo="3ec3a129-928e-4152-9f98-2baa194e66c4" carrier="7b32e287-d775-480c-b317-64ffdacf12c9_ret"/>
      ...
      <asset xsi:type="esdl:Joint" name="Joint_1_ret" id="6d97700c-a3d7-4127-b64c-f08ee2e308f9">
        ...
        <port xsi:type="esdl:OutPort" id="2913e645-b027-429e-bf5d-22ace96a39fa" name="ret_port" connectedTo="dd50e603-c87c-4cdb-82bb-486ebee77255 42e9f86b-ea96-4992-bf3f-9cbae8a4a39c c87f51df-7a53-41f4-948d-aba7b06046c2" carrier="7b32e287-d775-480c-b317-64ffdacf12c9_ret"/>
        <port xsi:type="esdl:InPort" id="7893125d-d82f-4fe8-aaea-5fb6afecc635" name="ret_port" connectedTo="0431b8a0-a8d1-4375-b348-37a475add47a 6b655eb1-2b66-455f-90a3-0dd6f2844fab 8271240c-cae3-4e81-8b36-d65302a4e6b4 b314b276-dcb4-4668-a337-5eef17ff164d" carrier="7b32e287-d775-480c-b317-64ffdacf12c9_ret"/>
      </asset>
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe1_ret" length="245.7" id="Pipe1_ret" innerDiameter="0.4444" outerDiameter="0.63" related="Pipe1">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe3_ret" length="241.6" id="Pipe3_ret" innerDiameter="0.4444" outerDiameter="0.63" related="Pipe3">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe4_ret" length="189.7" id="Pipe4_ret" innerDiameter="0.4444" outerDiameter="0.63" related="Pipe4">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe5_ret" length="244.6" id="Pipe5_ret" innerDiameter="0.4444" outerDiameter="0.63" related="Pipe5">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe6_ret" length="176.6" id="Pipe6_ret" innerDiameter="0.4444" outerDiameter="0.63" related="Pipe6">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:HeatStorage" name="HeatStorage_74c1" id="74c13eed-9ca8-4247-bd72-a68e242d8e1b" maxDischargeRate="10000000.0" maxChargeRate="10000000.0" volume="500.0">
        ...
        <port xsi:type="esdl:InPort" id="88fff38a-79af-4213-98fe-6455176ec8de" name="Elec" connectedTo="7b1d4bee-3202-4e2b-be73-793dd266e849" carrier="61fe47b3-2024-4c8f-97a1-140242ef2d99"/>
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe_9768" id="97684360-d920-45c2-a584-a092fdcf91f1" innerDiameter="0.4444" length="149.0" outerDiameter="0.63">
        ...
        <port xsi:type="esdl:InPort" id="2e672d8b-ee9b-4c8b-8357-58ea984ae6be" name="In" connectedTo="c0eac4db-f5da-47f3-8202-8438d000bd32" carrier="7b32e287-d775-480c-b317-64ffdacf12c9"/>
        <port xsi:type="esdl:OutPort" id="636a1943-2289-4d57-a2dd-33aaa4f25b49" name="Out" connectedTo="8c09b9ff-5070-4fbc-97fe-db7a501932dc" carrier="7b32e287-d775-480c-b317-64ffdacf12c9"/>
        <material xsi:type="esdl:CompoundMatter" compoundType="LAYERED">
          <component xsi:type="esdl:CompoundMatterComponent" layerWidth="0.0063">
            <matter xsi:type="esdl:Material" thermalConductivity="52.15" name="steel" id="371c1d72-de35-4559-9b0e-47172e5d1d83"/>
          </component>
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN450" name="Pipe_9768_ret" id="3542e501-01ea-468b-9d4f-c1e7c67b43d9" innerDiameter="0.4444" length="192.1" outerDiameter="0.63">
        ...
        <port xsi:type="esdl:InPort" id="a581c340-3cab-46b1-924f-c5ddc0120de6" name="In" connectedTo="cc725203-e648-490f-a12d-91fa85ee58f2" carrier="7b32e287-d775-480c-b317-64ffdacf12c9_ret"/>
        <port xsi:type="esdl:OutPort" id="8271240c-cae3-4e81-8b36-d65302a4e6b4" name="Out" connectedTo="7893125d-d82f-4fe8-aaea-5fb6afecc635" carrier="7b32e287-d775-480c-b317-64ffdacf12c9_ret"/>
        <material xsi:type="esdl:CompoundMatter" compoundType="LAYERED">
          <component xsi:type="esdl:CompoundMatterComponent" layerWidth="0.0063">
            <matter xsi:type="esdl:Material" thermalConductivity="52.15" name="steel" id="371c1d72-de35-4559-9b0e-47172e5d1d83"/>
          </component>
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN400" name="Pipe_8125" outerDiameter="0.63" id="81250990-a84d-47c5-b923-b087329d35f8" innerDiameter="0.3938" length="233.1">
        ...
        <port xsi:type="esdl:InPort" id="d89aec21-40a8-4014-86ee-2aba9f3ccbe5" name="In" connectedTo="c0eac4db-f5da-47f3-8202-8438d000bd32" carrier="7b32e287-d775-480c-b317-64ffdacf12c9"/>
        <port xsi:type="esdl:OutPort" id="350d66d9-dea3-4a42-85e4-ec9e2c127444" name="Out" connectedTo="33a9041b-dd75-42c0-94a3-584c5e374927" carrier="7b32e287-d775-480c-b317-64ffdacf12c9"/>
        <dataSource xsi:type="esdl:DataSource" attribution="https://www.logstor.com/media/6506/product-catalogue-uk-202003.pdf" name="Logstor Product Catalogue Version 2020.03"/>
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN400" name="Pipe_8125_ret" outerDiameter="0.63" id="57872968-57f4-4702-a0d7-78987855e877" innerDiameter="0.3938" length="232.9">
        ...
        <port xsi:type="esdl:InPort" id="3ec3a129-928e-4152-9f98-2baa194e66c4" name="In" connectedTo="0117d26b-8ab1-44b5-afee-51702e431e52" carrier="7b32e287-d775-480c-b317-64ffdacf12c9_ret"/>
        <port xsi:type="esdl:OutPort" id="b314b276-dcb4-4668-a337-5eef17ff164d" name="Out" connectedTo="7893125d-d82f-4fe8-aaea-5fb6afecc635" carrier="7b32e287-d775-480c-b317-64ffdacf12c9_ret"/>
        <dataSource xsi:type="esdl:DataSource" attribution="https://www.logstor.com/media/6506/product-catalogue-uk-202003.pdf" name="Logstor Product Catalogue Version 2020.03"/>
      ...
      <asset xsi:type="esdl:GeothermalSource" id="50cfdd22-a041-4cd5-9811-c3a568988376" name="GeothermalSource_50cf" power="1000000.0" state="OPTIONAL">
        ...
        <costInformation xsi:type="esdl:CostInformation" id="c4c8779e-9777-4eff-b39d-472b7cd1f72c">
          <investmentCosts xsi:type="esdl:SingleValue" id="ae8bfb33-1875-47cb-b7d2-20484b236bd8" value="100000000.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" description="Cost in EUR/MW" id="752d2c3a-ffaf-44bc-afe2-3ad82944cd04" unit="EURO" perMultiplier="MEGA" perUnit="WATT"/>
          </investmentCosts>
          <variableOperationalCosts xsi:type="esdl:SingleValue" id="5d707184-0bea-452a-be14-d8777918929f" value="500.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" description="Cost in EUR/MWh" id="32e26616-03ec-410c-8487-4e9d51a3323c" unit="EURO" perMultiplier="MEGA" perUnit="WATTHOUR"/>
          </variableOperationalCosts>
          <fixedOperationalCosts xsi:type="esdl:SingleValue" id="aa3812ea-9553-4ba7-9559-a527d0c7b6ad" value="100000.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" description="Cost in EUR/MW" id="dd4dc712-5a70-4aaa-b89a-840bc9e589ef" unit="EURO" perMultiplier="MEGA" perUnit="WATT"/>
          </fixedOperationalCosts>
        </costInformation>
      </asset>
      <asset xsi:type="esdl:Pipe" id="fa81d078-5361-44e0-be59-acee6a92a982" name="Pipe12345" length="287.4" state="OPTIONAL" diameter="DN150">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lat="52.04409096358859" lon="4.308131933212281"/>
          <point xsi:type="esdl:Point" lat="52.042720861938854" lon="4.311695247888566"/>
        </geometry>
        <port xsi:type="esdl:InPort" id="38ca5eab-3f3a-4164-83b2-ed55ad1d890e" name="In" connectedTo="e8b959ea-f9d9-4977-b05c-65e38ae251c5" carrier="7b32e287-d775-480c-b317-64ffdacf12c9"/>
        <port xsi:type="esdl:OutPort" id="2e5a4c65-5fdf-4c39-b87a-2c9682b69e35" name="Out" connectedTo="51852861-aeeb-461f-b8ec-08f000abc6dd" carrier="7b32e287-d775-480c-b317-64ffdacf12c9"/>
      </asset>
      <asset xsi:type="esdl:Pipe" id="ad844ff3-461a-48c3-838a-8d02cedf8add" name="Pipe12345_return" length="286.4" state="OPTIONAL" diameter="DN150">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lat="52.04281086202885" lon="4.311074402665649"/>
          <point xsi:type="esdl:Point" lat="52.0438402076067" lon="4.307810068130494"/>
          <point xsi:type="esdl:Point" lat="52.04409096358859" lon="4.308131933212281"/>
        </geometry>
        <port xsi:type="esdl:InPort" id="c87f51df-7a53-41f4-948d-aba7b06046c2" name="In" connectedTo="2913e645-b027-429e-bf5d-22ace96a39fa" carrier="7b32e287-d775-480c-b317-64ffdacf12c9_ret"/>
        <port xsi:type="esdl:OutPort" id="3e82b128-215f-421b-a36e-99588b5f22cc" name="Out" connectedTo="935de838-17c7-4788-9253-7831bc30621d" carrier="7b32e287-d775-480c-b317-64ffdacf12c9_ret"/>
      </asset>
      <asset xsi:type="esdl:ElectricityProducer" id="feac475a-37e5-4b2a-a8b1-d8a776a4f6d2" name="ElectricityProducer_feac" power="50000000.0">
        <geometry xsi:type="esdl:Point" lat="52.04269529840362" lon="4.314499503714356"/>
        <port xsi:type="esdl:OutPort" id="19648060-bba7-47c8-a02d-4b9513bf2065" name="Out" connectedTo="4a336bd0-f019-4daa-ad35-e44dd8c3b170" carrier="61fe47b3-2024-4c8f-97a1-140242ef2d99"/>
      </asset>
      <asset xsi:type="esdl:ElectricityCable" id="9b6e9f21-f35f-4d22-9a73-14dfaa98ff1f" name="ElectricityCable_9b6e" length="43.1" capacity="50000000.0">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lat="52.04269529840362" lon="4.314499503714356"/>
          <point xsi:type="esdl:Point" lat="52.042658996032856" lon="4.313871860504151"/>
        </geometry>
        <port xsi:type="esdl:InPort" id="4a336bd0-f019-4daa-ad35-e44dd8c3b170" name="In" connectedTo="19648060-bba7-47c8-a02d-4b9513bf2065" carrier="61fe47b3-2024-4c8f-97a1-140242ef2d99"/>
        <port xsi:type="esdl:OutPort" id="7b1d4bee-3202-4e2b-be73-793dd266e849" name="Out" connectedTo="88fff38a-79af-4213-98fe-6455176ec8de" carrier="61fe47b3-2024-4c8f-97a1-140242ef2d99"/>
      </asset>
    </area>
  </instance>
</esdl:EnergySystem>
