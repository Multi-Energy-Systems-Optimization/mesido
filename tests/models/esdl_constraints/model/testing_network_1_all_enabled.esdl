...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="testing with return network" description="" id="9435f4dc-37bd-4f06-b597-c4bf6384dd60_with_return_network" esdlVersion="v2602" version="9">
  <instance xsi:type="esdl:Instance" id="7e76f9af-9ce6-446c-8b40-4eedf486c50f" name="Untitled instance">
    <area xsi:type="esdl:Area" id="3012ea70-48a2-4f0a-a96f-d15ebe709fef" name="Untitled area">
      <asset xsi:type="esdl:HeatStorage" id="50b63767-3642-40b6-9fdb-1e1ee40540cf" name="HeatStorage_50b6" volume="0.9">
      ...
      <asset xsi:type="esdl:HeatExchange" id="1cf594d9-9b06-4e5a-b1fc-d86481573cde" name="HeatExchange_1cf5" capacity="0.9">
      ...
      <asset xsi:type="esdl:HeatPump" id="6e86dbe9-3ff5-46d9-b9dd-84b15b78ac47" name="HeatPump_6e86" COP="3.0" power="0.9">
      ...
      <asset xsi:type="esdl:HeatProducer" id="1c317dbf-8039-480c-9360-e983dc198730" name="HeatProducer_1c31" power="0.9">
      ...
      <asset xsi:type="esdl:GeothermalSource" id="0a384daf-2539-4f92-89c8-54db1b94a82b" name="GeothermalSource_0a38" power="9000000000.0" aggregationCount="3">
      ...
      <asset xsi:type="esdl:ATES" id="49ac1e95-076e-4bed-a765-64c7b589765f" name="ATES_49ac" maxChargeRate="0.9" maxDischargeRate="0.9" aggregationCount="3">
      ...
      <asset xsi:type="esdl:GasHeater" id="11d9b04a-83c3-4277-a915-2b6cbaa17957" name="GasHeater_11d9" power="90000000.0">
      ...
      <asset xsi:type="esdl:ElectricBoiler" id="ac4cd54a-c2b8-4587-bea3-8dae6c3e657c" name="ElectricBoiler_ac4c" power="90000000.0">
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe1" name="Pipe1" length="20.4" related="Pipe1_ret" diameter="DN700">
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe2" name="Pipe2" length="20.4" related="Pipe2_ret" diameter="DN700">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe3" name="Pipe3" length="4.88" related="Pipe3_ret" diameter="DN700">
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe4" name="Pipe4" length="6.67" related="Pipe4_ret" diameter="DN700">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lat="51.99824565579524" lon="4.368930235505105"/>
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe5" name="Pipe5" length="14.91" related="Pipe5_ret" diameter="DN700">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe6" name="Pipe6" length="19.94" related="Pipe6_ret" diameter="DN700">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe7" name="Pipe7" length="9.88" related="Pipe7_ret" diameter="DN700">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lat="51.99824565579524" lon="4.368930235505105"/>
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe8" name="Pipe8" length="16.52" related="Pipe8_ret" diameter="DN700">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lat="51.998204783689076" lon="4.368802160024644"/>
          <point xsi:type="esdl:Point" lat="51.99813377347649" lon="4.368590265512467"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe9" name="Pipe9" length="9.3" related="Pipe9_ret" diameter="DN700">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe10" name="Pipe10" length="7.6" related="Pipe10_ret" diameter="DN700">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lat="51.998194875294075" lon="4.368541985750199"/>
          <point xsi:type="esdl:Point" lat="51.99813377347649" lon="4.368590265512467"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe11" name="Pipe11" length="9.8" related="Pipe11_ret" diameter="DN700">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lat="51.998204783689076" lon="4.368802160024644"/>
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe12" name="Pipe12" length="12.2" related="Pipe12_ret" diameter="DN700">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" length="20.4" id="Pipe1_ret" name="Pipe1_ret" related="Pipe1" diameter="DN700">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="20.4" id="Pipe2_ret" name="Pipe2_ret" related="Pipe2" diameter="DN700">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="4.88" id="Pipe3_ret" name="Pipe3_ret" related="Pipe3" diameter="DN700">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="6.67" id="Pipe4_ret" name="Pipe4_ret" related="Pipe4" diameter="DN700">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="14.91" id="Pipe5_ret" name="Pipe5_ret" related="Pipe5" diameter="DN700">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="19.94" id="Pipe6_ret" name="Pipe6_ret" related="Pipe6" diameter="DN700">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99813542349358" lon="4.367546665616116"/>
      ...
      <asset xsi:type="esdl:Pipe" length="9.88" id="Pipe7_ret" name="Pipe7_ret" related="Pipe7" diameter="DN700">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="16.52" id="Pipe8_ret" name="Pipe8_ret" related="Pipe8" diameter="DN700">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99822377356649" lon="4.367800561898786"/>
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99829478377907" lon="4.3680127996935205"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" length="9.3" id="Pipe9_ret" name="Pipe9_ret" related="Pipe9" diameter="DN700">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99813542349358" lon="4.367546665616116"/>
      ...
      <asset xsi:type="esdl:Pipe" length="7.6" id="Pipe10_ret" name="Pipe10_ret" related="Pipe10" diameter="DN700">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99822377356649" lon="4.367800561898786"/>
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99828487538407" lon="4.367752577537374"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" length="9.8" id="Pipe11_ret" name="Pipe11_ret" related="Pipe11" diameter="DN700">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="12.2" id="Pipe12_ret" name="Pipe12_ret" related="Pipe12" diameter="DN700">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99813542349358" lon="4.367546665616116"/>
