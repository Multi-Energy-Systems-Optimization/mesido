...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="testing with return network" description="" id="9435f4dc-37bd-4f06-b597-c4bf6384dd60_with_return_network" esdlVersion="v2602" version="9">
  <instance xsi:type="esdl:Instance" id="7e76f9af-9ce6-446c-8b40-4eedf486c50f" name="Untitled instance">
    <area xsi:type="esdl:Area" id="3012ea70-48a2-4f0a-a96f-d15ebe709fef" name="Untitled area">
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe1" name="Pipe1" length="20.4" diameter="DN700" related="Pipe1_ret">
        ...
        <constraint xsi:type="esdl:PipeDiameterConstraint" id="5364ce3c-e171-4bd9-95c8-0526df2d5ad1" name="NewPipeDiameterConstraint" maximum="DN1200"/>
      </asset>
      <asset xsi:type="esdl:Pipe" id="Pipe2" name="Pipe2" length="20.4" diameter="DN700" related="Pipe2_ret">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
        ...
        <constraint xsi:type="esdl:PipeDiameterConstraint" id="227f37e0-88a0-4868-89ba-194c0af16b6b" name="NewPipeDiameterConstraint" maximum="DN1200"/>
      </asset>
      <asset xsi:type="esdl:Pipe" id="Pipe3" name="Pipe3" length="4.88" diameter="DN700" related="Pipe3_ret">
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe4" name="Pipe4" length="6.67" diameter="DN700" related="Pipe4_ret">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lat="51.99824565579524" lon="4.368930235505105"/>
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe5" name="Pipe5" length="14.91" diameter="DN700" related="Pipe5_ret">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe6" name="Pipe6" length="19.94" diameter="DN700" related="Pipe6_ret">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe7" name="Pipe7" length="9.88" diameter="DN700" related="Pipe7_ret">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lat="51.99824565579524" lon="4.368930235505105"/>
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe8" name="Pipe8" length="16.52" diameter="DN700" related="Pipe8_ret">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lat="51.998204783689076" lon="4.368802160024644"/>
          <point xsi:type="esdl:Point" lat="51.99813377347649" lon="4.368590265512467"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe9" name="Pipe9" length="9.3" diameter="DN700" related="Pipe9_ret">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe10" name="Pipe10" length="7.6" diameter="DN700" related="Pipe10_ret">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lat="51.998194875294075" lon="4.368541985750199"/>
          <point xsi:type="esdl:Point" lat="51.99813377347649" lon="4.368590265512467"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe11" name="Pipe11" length="9.8" diameter="DN700" related="Pipe11_ret">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lat="51.998204783689076" lon="4.368802160024644"/>
      ...
      <asset xsi:type="esdl:Pipe" id="Pipe12" name="Pipe12" length="12.2" diameter="DN700" related="Pipe12_ret">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" length="20.4" id="Pipe1_ret" name="Pipe1_ret" diameter="DN700" related="Pipe1">
        <geometry xsi:type="esdl:Line">
        ...
        <constraint xsi:type="esdl:PipeDiameterConstraint" id="edc05107-43f8-4eff-abfd-9b1bde608e48" name="NewPipeDiameterConstraint" maximum="DN1200"/>
      </asset>
      <asset xsi:type="esdl:Pipe" length="20.4" id="Pipe2_ret" name="Pipe2_ret" diameter="DN700" related="Pipe2">
        <geometry xsi:type="esdl:Line">
        ...
        <constraint xsi:type="esdl:PipeDiameterConstraint" id="2fb46651-0c8e-43b7-a117-9081cba519cd" name="NewPipeDiameterConstraint" maximum="DN1200"/>
      </asset>
      <asset xsi:type="esdl:Pipe" length="4.88" id="Pipe3_ret" name="Pipe3_ret" diameter="DN700" related="Pipe3">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="6.67" id="Pipe4_ret" name="Pipe4_ret" diameter="DN700" related="Pipe4">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="14.91" id="Pipe5_ret" name="Pipe5_ret" diameter="DN700" related="Pipe5">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="19.94" id="Pipe6_ret" name="Pipe6_ret" diameter="DN700" related="Pipe6">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99813542349358" lon="4.367546665616116"/>
      ...
      <asset xsi:type="esdl:Pipe" length="9.88" id="Pipe7_ret" name="Pipe7_ret" diameter="DN700" related="Pipe7">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="16.52" id="Pipe8_ret" name="Pipe8_ret" diameter="DN700" related="Pipe8">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99822377356649" lon="4.367800561898786"/>
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99829478377907" lon="4.3680127996935205"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" length="9.3" id="Pipe9_ret" name="Pipe9_ret" diameter="DN700" related="Pipe9">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99813542349358" lon="4.367546665616116"/>
      ...
      <asset xsi:type="esdl:Pipe" length="7.6" id="Pipe10_ret" name="Pipe10_ret" diameter="DN700" related="Pipe10">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99822377356649" lon="4.367800561898786"/>
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99828487538407" lon="4.367752577537374"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" length="9.8" id="Pipe11_ret" name="Pipe11_ret" diameter="DN700" related="Pipe11">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" length="12.2" id="Pipe12_ret" name="Pipe12_ret" diameter="DN700" related="Pipe12">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" CRS="WGS84" lat="51.99813542349358" lon="4.367546665616116"/>
