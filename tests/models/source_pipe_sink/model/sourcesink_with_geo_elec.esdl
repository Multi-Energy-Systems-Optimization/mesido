...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" version="10" id="5d539f68-f98e-466b-9ff5-b908a211e0ab_with_return_network_with_return_network" name="sourcesink_withHP_voc" description="" esdlVersion="v2401">
  <instance xsi:type="esdl:Instance" name="Untitled instance" id="90e7e098-038e-4462-89fe-a8852c501753">
    <area xsi:type="esdl:Area" id="4fd1adc2-5371-4ab7-806a-b40e49d127e9" name="Untitled area">
      ...
      <asset xsi:type="esdl:ElectricityCable" length="423.0" capacity="10000000.0" id="ce45d623-9749-42d2-b6e0-de0f09d1884b" name="ElectricityCable_ce45">
        ...
        <port xsi:type="esdl:OutPort" id="8303c87a-d294-4504-b8b9-17696494ebf3" name="Out" carrier="0e237e2a-00d1-4c6c-b966-9c9b8d9657f8" connectedTo="598d1f57-6033-4387-bdf1-edf77f120d52"/>
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:GeothermalSource" id="a77bc442-c981-4d26-a308-b65be7224f6f" name="GeothermalSource_a77b" power="10000000.0" COP="10.0">
        ...
        <port xsi:type="esdl:InPort" id="598d1f57-6033-4387-bdf1-edf77f120d52" name="ElecIn" connectedTo="8303c87a-d294-4504-b8b9-17696494ebf3" carrier="0e237e2a-00d1-4c6c-b966-9c9b8d9657f8"/>
      </asset>
    </area>
  </instance>
