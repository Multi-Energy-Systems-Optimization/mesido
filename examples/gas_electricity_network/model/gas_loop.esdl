...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="gas_loop" description="" id="cc3b855b-0403-4df8-a84f-8ea6fd25420e" esdlVersion="v250501" version="64">
    ...
    <area xsi:type="esdl:Area" id="74ab5996-6a79-4cd6-9fa8-4f1a498722f5" name="Untitled area">
      ...
      <asset xsi:type="esdl:GasHeater" id="d39b63a4-f19d-4144-8168-f89f19d5d8ff" name="GasHeater_1" power="10000000.0" efficiency="0.8" state="OPTIONAL">
        ...
        <costInformation xsi:type="esdl:CostInformation" id="d341d162-48d3-498e-be3a-5b4191740d09">
          ...
          <variableOperationalCosts xsi:type="esdl:SingleValue" id="47fbf4e7-b00d-43aa-964d-195fc336cf5b" value="1000000.0">
      ...
      <asset xsi:type="esdl:Joint" id="677dc2e8-802a-4883-87d7-0affcf02c480" name="Joint_677d">
        ...
        <port xsi:type="esdl:InPort" id="79424184-fe22-430e-9989-53c0f05d8084" name="In" connectedTo="4ddc33c0-9684-41ec-aafa-4023191d804a" carrier="b73c23fb-3b07-47b3-9c04-47dabc1116a3"/>
      ...
      <asset xsi:type="esdl:Pipe" id="7be9a7dd-4f79-4e53-87f9-b5ab2bb5d70e" name="Pipe_prod" innerDiameter="0.3938" outerDiameter="0.56" diameter="DN400" length="130.08" state="OPTIONAL">
        ...
        <costInformation xsi:type="esdl:CostInformation" id="eb801774-2512-4799-b7f7-99268cc6643e">
          <investmentCosts xsi:type="esdl:SingleValue" id="7134ab20-fdcb-4fc6-88c5-47451e56e0d6" value="2840.6">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" description="Cost in EUR/m" id="6f0d079d-f4d0-4423-a8a6-322909aa9742" unit="EURO" perUnit="METRE"/>
          </investmentCosts>
        </costInformation>
      ...
      <asset xsi:type="esdl:Pipe" id="597cad97-1341-4c33-acaf-2fd2ea14f074" name="Pipe_dem_1" innerDiameter="0.3938" outerDiameter="0.56" diameter="DN400" length="87.84" state="OPTIONAL">
        <dataSource xsi:type="esdl:DataSource" name="Logstor Product Catalogue Version 2020.03" attribution="https://www.logstor.com/media/6506/product-catalogue-uk-202003.pdf"/>
        <costInformation xsi:type="esdl:CostInformation" id="eb801774-2512-4799-b7f7-99268cc6643e">
          <investmentCosts xsi:type="esdl:SingleValue" id="969d4e83-842e-4236-8a4b-7a67434d4046" value="2840.6">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" description="Cost in EUR/m" id="97275411-b17c-41da-aa3c-04c911414b4c" unit="EURO" perUnit="METRE"/>
          </investmentCosts>
        </costInformation>
        <material xsi:type="esdl:CompoundMatter" compoundType="LAYERED">
          <component xsi:type="esdl:CompoundMatterComponent" layerWidth="0.0063">
      ...
      <asset xsi:type="esdl:Pipe" id="8cbd9995-56d7-453f-bd4b-048202394f24" name="Pipe_left" innerDiameter="0.3938" outerDiameter="0.56" diameter="DN400" length="556.7" state="OPTIONAL">
        ...
        <costInformation xsi:type="esdl:CostInformation" id="4e83435e-f40b-4a40-a02f-22085e5f5cb8">
          <investmentCosts xsi:type="esdl:SingleValue" id="2bbe2d00-88ba-4353-8d11-4a01751c4c34" value="2840.6">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" description="Cost in EUR/m" id="d47588a4-18e1-4fe0-9583-bd900d36cf9f" unit="EURO" perUnit="METRE"/>
          </investmentCosts>
        </costInformation>
        <material xsi:type="esdl:CompoundMatter" compoundType="LAYERED">
          <component xsi:type="esdl:CompoundMatterComponent" layerWidth="0.0063">
      ...
      <asset xsi:type="esdl:Pipe" id="e5c8a808-95b7-4e87-acd5-c12e10652c6d" name="Pipe_right" innerDiameter="0.3938" outerDiameter="0.56" diameter="DN400" length="309.0" state="OPTIONAL">
        ...
        <costInformation xsi:type="esdl:CostInformation" id="778ed3ff-3fcb-4edf-9186-a4d17c363c98">
          <investmentCosts xsi:type="esdl:SingleValue" id="186b7868-37dc-47c0-bd1c-24a1dd58381f" value="2840.6">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" description="Cost in EUR/m" id="a845f9f4-6b93-4467-8608-d13d0bfd776b" unit="EURO" perUnit="METRE"/>
          </investmentCosts>
        </costInformation>
        <material xsi:type="esdl:CompoundMatter" compoundType="LAYERED">
          <component xsi:type="esdl:CompoundMatterComponent" layerWidth="0.0063">
      ...
      <asset xsi:type="esdl:Pipe" id="4669b4d0-39d3-4770-afe6-7a0a1bf3d41f" name="Pipe_dem_2" innerDiameter="0.3938" outerDiameter="0.56" diameter="DN400" length="28.5" state="OPTIONAL">
        ...
        <costInformation xsi:type="esdl:CostInformation" id="0547ccfa-6793-4f09-b2a5-601ccdd8620c">
          <investmentCosts xsi:type="esdl:SingleValue" id="9ad1524a-2dc1-4127-9823-b7badff118e3" value="2840.6">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" description="Cost in EUR/m" id="276b4ae0-544b-4357-976b-31a2ded3dc4e" unit="EURO" perUnit="METRE"/>
          </investmentCosts>
        </costInformation>
        <material xsi:type="esdl:CompoundMatter" compoundType="LAYERED">
          <component xsi:type="esdl:CompoundMatterComponent" layerWidth="0.0063">
      ...
      <asset xsi:type="esdl:Joint" id="f93adf87-4a51-42ea-9a1d-4576fd7ee040" name="Joint_f93a">
        ...
        <port xsi:type="esdl:InPort" id="37fe23e9-1282-4f27-a8cf-04c1e5d67f54" name="In" connectedTo="c9d03d55-4aab-46bd-bbca-c54bd2c1808b" carrier="b73c23fb-3b07-47b3-9c04-47dabc1116a3"/>
      ...
      <asset xsi:type="esdl:Joint" id="191ab9b5-db7a-4f47-a4a7-352a69b506c9" name="Joint_191a">
        ...
        <port xsi:type="esdl:OutPort" id="da9d1d6f-6f62-4b43-8e22-24a681355c68" name="Out" connectedTo="1263c55d-13b0-43e8-abf6-d30aaff40c2e" carrier="1d5f7417-03b1-4467-9d61-e11e36dcaf43"/>
      </asset>
    </area>
  </instance>
