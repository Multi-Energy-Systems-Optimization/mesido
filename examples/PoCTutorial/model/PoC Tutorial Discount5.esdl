...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="PoC Tutorial Discount5" id="15174819-d1af-4ba6-9f1d-2cd07991f14a" description="" esdlVersion="v2207" version="17">
  ...
  <instance xsi:type="esdl:Instance" id="9af52a01-24e2-4bbe-a7b8-f868161e6ca3" name="Untitled instance">
    <area xsi:type="esdl:Area" name="Untitled area" id="9edf5aa3-3855-4dac-b6f5-01c2edf1a43a">
      <asset xsi:type="esdl:ResidualHeatSource" technicalLifetime="15.0" power="50000000.0" name="ResidualHeatSource_72d7" id="72d74fb5-134f-4bfb-829e-220ab76a8a7b" state="OPTIONAL">
        ...
        <costInformation xsi:type="esdl:CostInformation" id="123cc46e-f8ef-42f9-842f-08e77dd06899">
          ...
          <discountRate xsi:type="esdl:SingleValue" id="ef09f648-757e-489b-9615-a7a77bab5871" value="5.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" description="Cost in %" id="dce0eae4-5831-40f6-9cad-5ac3da6aeade" unit="PERCENT"/>
          </discountRate>
        </costInformation>
      </asset>
      <asset xsi:type="esdl:Pipe" diameter="DN900" name="Pipe1" outerDiameter="0.56" length="818.07" innerDiameter="0.3938" id="Pipe1" state="OPTIONAL" related="Pipe1_ret">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN900" name="Pipe4" outerDiameter="0.45" length="455.4" innerDiameter="0.3127" id="Pipe4" state="OPTIONAL" related="Pipe4_ret">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN900" name="Pipe1_ret" outerDiameter="0.56" id="Pipe1_ret" length="818.07" innerDiameter="0.3938" state="OPTIONAL" related="Pipe1">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN900" name="Pipe4_ret" outerDiameter="0.45" id="Pipe4_ret" length="455.4" innerDiameter="0.3127" state="OPTIONAL" related="Pipe4">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:ResidualHeatSource" technicalLifetime="30.0" power="50000000.0" name="ResidualHeatSource_76f0" id="76f0817c-9f01-431e-be96-dbf3ee806d76" state="OPTIONAL">
        ...
        <costInformation xsi:type="esdl:CostInformation" id="8a3abfe2-d012-489d-87c3-2732a6d4b25f">
          ...
          <discountRate xsi:type="esdl:SingleValue" id="480075d7-5828-4290-a794-8136573a6010" value="5.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="COST" description="Cost in %" id="7ff71f5b-8898-4d7c-a65e-e0e884f98f36" unit="PERCENT"/>
          </discountRate>
        </costInformation>
      </asset>
      <asset xsi:type="esdl:Pipe" diameter="DN250" related="Pipe_8fa5_ret" name="Pipe_8fa5" length="356.2" outerDiameter="0.4" innerDiameter="0.263" id="Pipe_8fa5" state="OPTIONAL">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" diameter="DN250" related="Pipe_8fa5" name="Pipe_8fa5_ret" length="304.4" outerDiameter="0.4" innerDiameter="0.263" id="Pipe_8fa5_ret" state="OPTIONAL">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <area xsi:type="esdl:Area" name="Area_76a7" id="76a75122-8ea6-472d-8059-374830275d72">
        <asset xsi:type="esdl:HeatingDemand" name="HeatingDemand_b0ff" id="b0ff0df6-4a47-43a5-a0a5-aa10975c0a5c" power="15000000.0">
          ...
          <port xsi:type="esdl:InPort" id="2c5a109b-0d98-47b6-acc1-05e1708f8b85" name="In" connectedTo="5169316d-ae93-4f04-9a34-7c776444b651" carrier="9f6aeb1a-138b-4bb9-9a09-d524e94658e6">
            <profile xsi:type="esdl:InfluxDBProfile" multiplier="5.5" startDate="2018-12-31T23:00:00.000000+0000" filters="" id="b8150ac7-ea23-4be6-b5a3-b6974b8df58d" database="energy_profiles" measurement="WarmingUp default profiles" host="profiles.warmingup.info" field="demand4_MW" port="443" endDate="2019-12-31T22:00:00.000000+0000">
