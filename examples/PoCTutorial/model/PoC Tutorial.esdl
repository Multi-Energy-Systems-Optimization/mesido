...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="PoC Tutorial_SmartControlOptimized" id="15174819-d1af-4ba6-9f1d-2cd07991f14a" description="" esdlVersion="v2207" version="13">
  ...
  <instance xsi:type="esdl:Instance" id="9af52a01-24e2-4bbe-a7b8-f868161e6ca3" name="Untitled instance">
    <area xsi:type="esdl:Area" name="Untitled area" id="9edf5aa3-3855-4dac-b6f5-01c2edf1a43a">
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe1_ret" diameter="DN900" name="Pipe1" outerDiameter="0.56" length="818.07" innerDiameter="0.3938" id="Pipe1" state="OPTIONAL">
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe4_ret" diameter="DN900" name="Pipe4" outerDiameter="0.45" length="455.4" innerDiameter="0.3127" id="Pipe4" state="OPTIONAL">
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe1" diameter="DN900" name="Pipe1_ret" outerDiameter="0.56" id="Pipe1_ret" length="818.07" innerDiameter="0.3938" state="OPTIONAL">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe4" diameter="DN900" name="Pipe4_ret" outerDiameter="0.45" id="Pipe4_ret" length="455.4" innerDiameter="0.3127" state="OPTIONAL">
        <geometry xsi:type="esdl:Line">
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe_8fa5_ret" diameter="DN250" name="Pipe_8fa5" length="356.2" outerDiameter="0.4" innerDiameter="0.263" id="Pipe_8fa5" state="OPTIONAL">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe_8fa5" diameter="DN250" name="Pipe_8fa5_ret" length="304.4" outerDiameter="0.4" innerDiameter="0.263" id="Pipe_8fa5_ret" state="OPTIONAL">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
